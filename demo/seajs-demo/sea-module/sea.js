...
!function(a, b) {
    ...
    function p(a, b, c) {
        ...
        d.src = a,
        bb = d,
        ab ? _.insertBefore(d, ab) : _.appendChild(d),
        bb = null
    }
    function q(a, b, c) {
        function d(c) {
            a.onload = a.onerror = a.onreadystatechange = null,
            v.debug || _.removeChild(a),
            a = null,
            b(c)
        }
        var e = "onload"in a;
    ...
    function r() {
        if (bb)
            return bb;
        if (cb && "interactive" === cb.readyState)
            return cb;
    ...
    function s(a) {
        ...
        function h() {
            ...
            o = /^require\s*\(\s*(['"]).+?\1\s*\)/.test(b),
            o ? (c = /^require\s*\(\s*['"]/.exec(b)[0],
        ...
        if (-1 == a.indexOf("require"))
            return [];
        for (var k = 0, l, m = a.length, n = 1, o = 0, p = 0, q = [], r = []; m > k; )
            b(),
            c() || (d() ? (e(),
            n = 1) : "/" == l ? (b(),
            "/" == l ? (k = a.indexOf("\n", k),
            -1 == k && (k = a.length)) : "*" == l ? (k = a.indexOf("*/", k),
            -1 == k ? k = m : k += 2) : n ? (f(),
            n = 0) : (k--,
            n = 1)) : g() ? h() : i() ? j() : "(" == l ? (q.push(p),
            n = 1) : ")" == l ? n = q.pop() : (n = "]" != l,
            o = 0));
        return r
    }
    ...
    if (!a.seajs) {
        ...
        t.prototype.pass = function() {
            for (var a = this, b = a.dependencies.length, c = 0; c < a._entry.length; c++) {
                for (var d = a._entry[c], e = 0, f = 0; b > f; f++) {
                    ...
                    g.status < ib.LOADED && !d.history.hasOwnProperty(g.uri) && (d.history[g.uri] = !0,
                    e++,
                    g._entry.push(d),
                    g.status === ib.LOADING && g.pass())
                }
                e > 0 && (d.remain += e - 1,
                a._entry.shift(),
                c--)
        ...
        t.prototype.load = function() {
            ...
            if (!(a.status >= ib.LOADING)) {
                ...
                for (d = 0; e > d; d++)
                    g = db[c[d]],
                    g.status < ib.FETCHING ? g.fetch(f) : g.status === ib.SAVED && g.load();
                for (var h in f)
        ...
        t.prototype.fetch = function(a) {
            ...
            return !h || gb.hasOwnProperty(h) ? (e.load(),
            b) : fb.hasOwnProperty(h) ? (hb[h].push(e),
            b) : (fb[h] = !0,
            hb[h] = [e],
            C("request", g = {
                uri: f,
        ...
        t.define = function(a, c, d) {
            ...
            C("define", f),
            f.uri ? t.save(f.uri, f) : eb = f
        }
        ,
        t.save = function(a, b) {
            var c = t.get(a);
            c.status < ib.SAVED && (c.id = b.id || a,
        ...
        u.require = function(a) {
            ...
            return b.status < ib.EXECUTING && (b.onload(),
            b.exec()),
            b.exports
        }
        ,
